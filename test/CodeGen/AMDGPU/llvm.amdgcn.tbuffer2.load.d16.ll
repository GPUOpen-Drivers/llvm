...
main_body:
  %data = call half @llvm.amdgcn.tbuffer2.load.f16(<4 x i32> %rsrc, i32 0, i32 0, i32 0, i32 0, i32 22, i32 0)
  ret half %data
}
...
main_body:
  %data = call <2 x half> @llvm.amdgcn.tbuffer2.load.v2f16(<4 x i32> %rsrc, i32 0, i32 0, i32 0, i32 0, i32 22, i32 0)
...
main_body:
  %data = call <4 x half> @llvm.amdgcn.tbuffer2.load.v4f16(<4 x i32> %rsrc, i32 0, i32 0, i32 0, i32 0, i32 22, i32 0)
  %elt = extractelement <4 x half> %data, i32 3
  ret half %elt
}

declare half @llvm.amdgcn.tbuffer2.load.f16(<4 x i32>, i32, i32, i32, i32, i32, i32)
declare <2 x half> @llvm.amdgcn.tbuffer2.load.v2f16(<4 x i32>, i32, i32, i32, i32, i32, i32)
declare <4 x half> @llvm.amdgcn.tbuffer2.load.v4f16(<4 x i32>, i32, i32, i32, i32, i32, i32)
