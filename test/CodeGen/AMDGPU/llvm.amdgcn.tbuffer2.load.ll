...
main_body:
    %vdata     = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 0, i32 0, i32 0, i32 0, i32 78, i32 0)
    %vdata_glc = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 0, i32 0, i32 0, i32 0, i32 63, i32 1)
    %vdata_slc = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 0, i32 0, i32 0, i32 0, i32 22, i32 2)
    %vdata_f32 = call <4 x float> @llvm.amdgcn.tbuffer2.load.v4f32(<4 x i32> %0, i32 0, i32 0, i32 0, i32 0, i32 22, i32 0)
...
main_body:
    %vdata   = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 0, i32 0, i32 0, i32 42, i32 78, i32 0)
    %vdata.f = bitcast <4 x i32> %vdata to <4 x float>
...
define amdgpu_vs {<4 x float>, <4 x float>, <4 x float>} @tbuffer_load_immoffs_large(<4 x i32> inreg, i32 inreg %soffs) {
    %vdata     = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 0, i32 0, i32 61, i32 4095, i32 47, i32 0)
    %vdata_glc = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 0, i32 0, i32 %soffs, i32 73, i32 62, i32 0)
    %vdata_slc = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 0, i32 0, i32 %soffs, i32 1, i32 77, i32 0)
    %vdata.f     = bitcast <4 x i32> %vdata to <4 x float>
    %vdata_glc.f = bitcast <4 x i32> %vdata_glc to <4 x float>
    %vdata_slc.f = bitcast <4 x i32> %vdata_slc to <4 x float>
...
main_body:
    %vdata   = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 %vindex, i32 0, i32 0, i32 0, i32 78, i32 0)
    %vdata.f = bitcast <4 x i32> %vdata to <4 x float>
    ret <4 x float> %vdata.f
}
...
main_body:
    %vdata   = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 0, i32 %voffs, i32 0, i32 0, i32 78, i32 0)
    %vdata.f = bitcast <4 x i32> %vdata to <4 x float>
    ret <4 x float> %vdata.f
}
...
main_body:
    %vdata   = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 0, i32 %voffs, i32 0, i32 52, i32 78, i32 0)
    %vdata.f = bitcast <4 x i32> %vdata to <4 x float>
    ret <4 x float> %vdata.f
}
...
main_body:
    %vdata   = call <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32> %0, i32 %vindex, i32 %voffs, i32 0, i32 0, i32 78, i32 0)
    %vdata.f = bitcast <4 x i32> %vdata to <4 x float>
    ret <4 x float> %vdata.f
}
...
define amdgpu_vs <2 x float> @buffer_load_xy(<4 x i32> inreg %rsrc) {
    %vdata = call <2 x i32> @llvm.amdgcn.tbuffer2.load.v2i32(<4 x i32> %rsrc, i32 0, i32 0, i32 0, i32 0, i32 77, i32 0)
...
define amdgpu_vs float @buffer_load_x(<4 x i32> inreg %rsrc) {
    %vdata = call i32 @llvm.amdgcn.tbuffer2.load.i32(<4 x i32> %rsrc, i32 0, i32 0, i32 0, i32 0, i32 77, i32 0)
    %vdata.f = bitcast i32 %vdata to float
    ret float %vdata.f
}

declare i32 @llvm.amdgcn.tbuffer2.load.i32(<4 x i32>, i32, i32, i32, i32, i32, i32)
declare <2 x i32> @llvm.amdgcn.tbuffer2.load.v2i32(<4 x i32>, i32, i32, i32, i32, i32, i32)
declare <4 x i32> @llvm.amdgcn.tbuffer2.load.v4i32(<4 x i32>, i32, i32, i32, i32, i32, i32)
declare <4 x float> @llvm.amdgcn.tbuffer2.load.v4f32(<4 x i32>, i32, i32, i32, i32, i32, i32)
